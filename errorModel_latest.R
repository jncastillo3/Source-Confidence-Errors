...
# change x-axis here 
par(mfrow=c(4,3))
hist(allSamples_err[,"dsMicEff[1]"], main = "Sanders Exp.1", c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[2]"], main = "Sanders Exp.2", c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[3]"], main = "SK Exp.3", c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[4]"], main = "Sk Exp 4.1", c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[5]"], main = "Sk Exp 4.2", c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[6]"], main = "Pazzaglia Exp. 2", c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[7]"], main = "Pazzaglia Exp. 3", c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[8]"], main = "Pazzaglia Exp. 4", c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[9]"], main = "Fox Exp. 1a Blocked", c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[10]"], main = "Fox Exp. 1a Reversed", c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[11]"], main = "Fox Exp. 1a Sim",c = "darksalmon", xlab = "Mean ICE (log odds)")
hist(allSamples_err[,"dsMicEff[12]"], main = "Fox Exp. 3a Sim", c = "darksalmon", xlab = "Mean ICE (log odds)")
...
par(mfrow=c(4,3))
hist(allSamples_err[,"dsMbeta0[1]"], main = "Sanders Exp.1", c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[2]"], main = "Sanders Exp.2", c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[3]"], main = "SK Exp.3", c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[4]"], main = "Sk Exp 4.1", c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[5]"], main = "Sk Exp 4.2", c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[6]"], main = "Pazzaglia Exp. 2", c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[7]"], main = "Pazzaglia Exp. 3", c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[8]"], main = "Pazzaglia Exp. 4", c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[9]"], main = "Fox Exp. 1a Blocked", c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[10]"], main = "Fox Exp. 1a Reversed", c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[11]"], main = "Fox Exp. 1a Sim",c = "darksalmon", xlab = "Mean intercept (log odds)")
hist(allSamples_err[,"dsMbeta0[12]"], main = "Fox Exp. 3a Sim", c = "darksalmon", xlab = "Mean intercept (log odds)")
